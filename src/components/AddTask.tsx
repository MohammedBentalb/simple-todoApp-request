...
function AddTask({
  ...
  return (
    <>
      ...
      ></div>
      <form
        className="absolute w-[400px] left-1/2 -translate-x-1/2 top-20 rounded z-50 bg-gray-300 py-4 px-2 flex flex-col items-center gap-3 max-sm:max-w-[300px] max-sm:w-full"
        method="POST"
